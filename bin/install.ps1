...
$zipPath = Join-Path $env:TEMP "mew-windows-x86_64.zip"
...
try {
    ...
    Write-Host "Found Mew version $version" -ForegroundColor Green
} catch {
...
if ($userPath -notlike "*$installDir*") {
    Write-Host "Adding Mew to your PATH..." -ForegroundColor Yellow
